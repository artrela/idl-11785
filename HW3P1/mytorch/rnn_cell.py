...
class RNNCell(object):
    ...
    def forward(self, x, h_prev_t):
        ...
        """
        return self.activation.forward( h_prev_t @ self.W_hh.T + self.b_hh[np.newaxis, :] 
                                        + x @ self.W_ih.T + self.b_ih[np.newaxis, :] )
    ...
    def backward(self, delta, h_t, h_prev_l, h_prev_t):
        ...
        self.db_ih += ( dz.T @ np.ones(batch_size) ) / batch_size # TODO
        self.db_hh += ( dz.T @ np.ones(batch_size) ) / batch_size # TODO
